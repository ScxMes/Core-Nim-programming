...
proc readInput(): string =
  ## This procedure will block its thread until a line is read from the
  ## standard input.
  ##
  ## Once a line is read, it will be returned.
...
var messageFlowVar = spawn readInput()
while true:
  ...
  if messageFlowVar.isReady():
    ...
    # new thread.
    messageFlowVar = spawn readInput()
